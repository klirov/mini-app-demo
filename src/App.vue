...
const handleCheckout = async () => {
    ...
    const isConfirmed = await showConfirmPopup(
        "Сейчас мы отправим заказ вам в чат, как, например, менеджеру в кофейне или любому администратору. Это демо-режим, вам не придется ничего оплачивать по-настоящему. Отправляем?",
        "Отправить в чат"
    );
